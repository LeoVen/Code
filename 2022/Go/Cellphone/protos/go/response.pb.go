...
type FetchSingleResponse struct {
...
func (x *FetchSingleResponse) Reset() {
	*x = FetchSingleResponse{}
...
func (x *FetchSingleResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchSingleResponse) ProtoMessage() {}

func (x *FetchSingleResponse) ProtoReflect() protoreflect.Message {
	mi := &file_response_proto_msgTypes[0]
...
// Deprecated: Use FetchSingleResponse.ProtoReflect.Descriptor instead.
func (*FetchSingleResponse) Descriptor() ([]byte, []int) {
	return file_response_proto_rawDescGZIP(), []int{0}
}

func (x *FetchSingleResponse) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *FetchSingleResponse) GetProviderId() int32 {
	if x != nil {
		return x.ProviderId
	}
	return 0
...
func (x *FetchSingleResponse) GetNumber() string {
	if x != nil {
		return x.Number
	}
	return ""
...
func (x *BulkInsertResponse) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
var file_response_proto_rawDesc = []byte{
	...
	0x1a, 0x0b, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5d, 0x0a,
	0x13, 0x46, 0x65, 0x74, 0x63, 0x68, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x02, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72,
	0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64,
	0x65, 0x72, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x2a, 0x0a, 0x12,
	...
	0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x1f, 0x5a, 0x1d, 0x63, 0x65, 0x6c, 0x6c,
...
var file_response_proto_goTypes = []interface{}{
	(*FetchSingleResponse)(nil), // 0: FetchSingleResponse
	(*BulkInsertResponse)(nil),  // 1: BulkInsertResponse
}
...
func file_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_response_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FetchSingleResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_response_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BulkInsertResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
